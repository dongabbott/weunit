...
export const asyncRouterMap = [
  {
    ...
    children: [
      { path: 'index', component: _import('users/usersTable'), name: 'users', meta: { title: 'users', icon: 'user' }},
      { path: 'group', component: _import('users/usersTable'), name: 'groups', meta: { title: 'groups', icon: 'peoples' }}
    ]
  },
  {
    path: '/project',
    ...
    children: [
      { path: 'index', component: _import('project/index'), name: 'project', meta: { title: 'project', icon: 'component' }}
    ]
  },
  {
    path: '/apitest',
